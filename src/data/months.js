    ...
    weeks: [
      {
        ...
        reading: [
          { text: "Understand what large language models are: prediction engines trained on text, not databases or search engines", url: "https://docs.anthropic.com/en/docs/overview", urlLabel: "Anthropic docs", contentKey: "w01-llm-basics" },
